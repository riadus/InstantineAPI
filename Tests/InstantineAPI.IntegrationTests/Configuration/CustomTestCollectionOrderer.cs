...
namespace InstantineAPI.IntegrationTests.Configuration
{
    ...
    {
        public const string TypeName = "InstantineAPI.IntegrationTests.Configuration.CustomTestCollectionOrderer";

        public const string AssembyName = "InstantineAPI.IntegrationTests";
